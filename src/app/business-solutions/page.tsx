            ...
            {solutions.map((item, i) => (
              <div key={i} className="bg-white rounded-xl sm:rounded-3xl overflow-hidden shadow-sm hover:shadow-2xl transition-all duration-300 border border-slate-100 group flex flex-col h-full">
                ...
                <div className="h-28 sm:h-56 relative overflow-hidden">
                   ...
                   <h3 className="absolute bottom-3 left-3 right-3 sm:bottom-6 sm:left-6 sm:right-6 text-sm sm:text-2xl font-bold text-white leading-tight">{item.title}</h3>
                </div>
                
                {/* Content */}
                <div className="p-4 sm:p-8 flex flex-col flex-grow">
                  <p className="text-slate-600 mb-4 sm:mb-8 text-xs sm:text-base font-medium leading-snug sm:leading-relaxed line-clamp-2 sm:line-clamp-none">{item.desc}</p>
                  
                  <div className="bg-blue-50 border border-blue-100 rounded-xl sm:rounded-2xl p-3 sm:p-5 mb-4 sm:mb-8 flex-grow">
                    <h4 className="text-[10px] sm:text-xs font-bold text-blue-600 uppercase tracking-wider mb-1 sm:mb-2">Recommended Ecosystem</h4>
                    <p className="font-bold text-slate-900 text-xs sm:text-base leading-tight">{item.solution}</p>
                  </div>
                  ...
                  >
                    ...
                    <span className="hidden sm:inline">Get this solution</span>
